    ...
    <div style="max-width: 850px; margin: 0 auto;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
        <div>
          ...
          <p class="text-muted" style="font-size: 0.85rem;">Official Reasoning Log &mdash; ${ch.title}</p>
        </div>
      ...
      <div class="card" style="margin-bottom: 1.5rem; border-color: var(--accent);">
        <h3 class="font-serif" style="font-size: 1.1rem; color: var(--accent); margin-bottom: 0.75rem; border-bottom: 1px solid var(--border-color); padding-bottom: 0.4rem;">INITIAL KNOWN FACTS</h3>
        ${initialFactsHtml}
      </div>

      <!-- CONFIRMED DEDUCTIONS -->
      <div class="card" style="margin-bottom: 1.5rem; border-color: var(--success);">
        <h3 class="font-serif" style="font-size: 1.1rem; color: var(--success); margin-bottom: 0.75rem; border-bottom: 1px solid var(--border-color); padding-bottom: 0.4rem;">CONFIRMED PLAYER DEDUCTIONS</h3>
        ${deductionsHtml}
      </div>
    </div>
  `;
